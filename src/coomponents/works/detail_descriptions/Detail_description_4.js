...
function Detail_description_4() {
    return (
      <Container>
        ...
        <br /><br /><br />
        <Text>TODOアプリ(Flask & React)</Text>
        <Text>以下のリンクから遷移できます</Text>
        <a href='https://todo-flask-api-react-front.herokuapp.com/' target='_blank'>
...
export default Detail_description_4