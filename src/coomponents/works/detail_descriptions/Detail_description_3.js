...
function Detail_description_3() {
    return (
      <Container>
        ...
        <br /><br /><br />
        <Text>ブログアプリ(Django & React)</Text>
        <Text>以下のリンクから遷移できます</Text>
        <a href='https://blog-djangoreact.herokuapp.com/' target='_blank'>
...
export default Detail_description_3